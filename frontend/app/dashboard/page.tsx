...
import {
  ...
  AnimatedGreeting,
  AnimatedHeatmap,
  AnimatedOverviewStrip,
  AnimatedScoreRing,
  StatNumber,
} from './_components/AnimatedDashboard'
...
export default async function DashboardHome() {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto w-full">
      ...
      {/* Greeting header — slides down on mount */}
      <AnimatedGreeting>
      ...
      {/* Overview strip — cells slide in from left with stagger */}
      <AnimatedOverviewStrip>
      ...
      {/* Today's Brief + Compliance Score — fade up with stagger */}
      <AnimatedCards>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-8">
          <div data-main-card className={`lg:col-span-2 relative ${CARD} p-6 overflow-hidden`}>
          ...
          {/* Compliance score — GSAP-animated ring + counter */}
          <div data-main-card className={`${CARD} p-6 flex flex-col items-center justify-center text-center`}>
      ...
      {/* Priority Actions + Latest Regulations */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-8">
      ...
      {/* Department heatmap — stagger animated cards */}
      <div className="mb-2">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-baseline gap-1 mt-1">
                      <StatNumber value={rate} className="text-2xl font-bold text-gray-900 tracking-tight" />
                      <span className="text-xl font-bold text-gray-900 leading-none">%</span>
                      <span className={`text-xs ml-1 ${overdue > 0 ? 'text-red-600 font-medium' : 'text-gray-400'}`}>
