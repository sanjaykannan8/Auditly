        ...
        <div className="w-full">
          <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100 px-8 py-9">
            <div className="flex flex-col items-center text-center mb-7">
              ...
              <h1 className="text-[22px] font-bold text-gray-900">Create your account</h1>
              <p className="text-[15px] text-gray-500 mt-1">Get started with Auditly in seconds</p>
            </div>
          ...
          <p className="text-center text-sm text-gray-600 mt-5">
            ...
            <Link href="/sign-in" className="font-semibold text-[#ff5d03] hover:text-[#e04f02]">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
